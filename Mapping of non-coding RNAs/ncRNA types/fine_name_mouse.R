transin <- read.table('name2type_mus.txt', header = FALSE, sep = '\t', stringsAsFactors = FALSE)
transin = transin[!duplicated(transin[,2]),]

transin[,1] = gsub("^(transcribed_unprocessed_pseudogene|translated_unprocessed_pseudogene|unprocessed_pseudogene|transcribed_processed_pseudogene|processed_pseudogene|transcribed_unitary_pseudogene|translated_processed_pseudogene|unitary_pseudogene|rRNA_pseudogene|IG_C_pseudogene|TR_J_pseudogene|TR_V_pseudogene||IG_C_pseudogene|TR_J_pseudogene|TR_V_pseudogene|IG_V_pseudogene|IG_pseudogene|IG_D_pseudogene|IG_V_pseudogene|IG_J_pseudogene|IG_pseudogene)$",'pseudogene',transin[,1])
transin[,1] = gsub("^Mt_tRNA$",'tRNA',transin[,1])
transin[,1] = gsub("^(IG_V_gene|IG_C_gene|IG_LV_gene|IG_J_gene|TR_C_gene|TR_J_gene|TR_V_gene|TR_D_gene|IG_D_gene)$",'protein_coding',transin[,1])
