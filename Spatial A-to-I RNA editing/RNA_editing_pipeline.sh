...
split_bam="Path to split bam file" # output split BAM file
# generate split BAM file using GATK
...
# count read counts at editing sites using samtools mpileup
