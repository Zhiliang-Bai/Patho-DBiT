...
cytoband.df = read.table("data/karyotype.human.hg38.bed", colClasses = c("character", "numeric","numeric", "character", "character"), sep = "\t")
cytoband.df[,1] = gsub('chr','',cytoband.df[,1])
CairoPDF("result/Figures/circos/circos_germline_1_3_LM0623.pdf",pointsize = 8,height = 7,width = 7,family = "Arial")
circos.clear()
