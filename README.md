...
The pipeline also requires a reference geneome fasta file, a GTF anntation file, a reference RNA editing sites file, a TSV file containing mapping between spatial locations and cluster IDs, and a TSV file containing mapping between cluster IDs and region names as inputs.
